  ...
  <div class="container-fluid ">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active me-3" href="addcustomers.php">Add Customers</a>
        </li>
        <li class="nav-item">
...
<div class="container">
</br><h1 >Tambah Customers</h1></br>
<form method="POST" action="addcustomers_exe.php">
  ...
  <div class="mb-3 row">
    <label for="nohp" class="col-sm-2 col-form-label fw-semibold">No HP</label>
    <div class="col-sm-10">
  ...
  <div class="mb-3 row">
    <label for="jk" class="col-sm-2 col-form-label fw-semibold">Jenis Kelamin</label>
    <div class="col-sm-10">
  ...
  <div class="mb-3 row">
    <label for="tipe" class="col-sm-2 col-form-label fw-semibold">Tipe Penginapan</label>
    <div class="col-sm-10">
  ...
  <div class="mb-3 row">
    <label for="statuskos" class="col-sm-2 col-form-label fw-semibold">Status</label>
    <div class="col-sm-10">
  ...
  <div class="mb-3 row">
    <label for="alamat" class="col-sm-2 col-form-label fw-semibold">Alamat Asal</label>
    <div class="col-sm-10">
